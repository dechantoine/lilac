"""PaLM2 Gecko's multilingual embeddings."""
...
EMBEDDING_MODEL = 'textembedding-gecko-multilingual@latest'
EMBEDDING_SIZE = 768


class PaLMGeckoMulti(ll.TextEmbeddingSignal):
    """Computes embeddings using PaLM's gecko multilingual embedding API.

    <br>**Important**: This will send data to an external server!

    <br>To use this signal, you must get a GCP_PROJECT_ID env variable
    """
    name: ClassVar[str] = 'palm2-gecko-multilingual'
    display_name: ClassVar[str] = 'PaLM2 Multilingual Embeddings'
